...
import com.i2u2.parent.fragments.ConversationFragment;
import com.i2u2.parent.fragments.IncomeCallFragment;
import com.i2u2.parent.fragments.OnCallEventsController;
import com.i2u2.parent.fragments.OpponentsFragment;
import com.i2u2.parent.holder.DataHolder;
import com.i2u2.parent.util.ChatPingAlarmManager;
import com.i2u2.parent.util.NetworkConnectionChecker;
import com.i2u2.parent.utils.Chat;
import com.i2u2.parent.utils.Consts;
import com.i2u2.parent.utils.FragmentExecuotr;
import com.i2u2.parent.utils.PrivateChatImpl;
import com.i2u2.parent.utils.QBChatMessageListener;
import com.i2u2.parent.utils.RingtonePlayer;
import com.i2u2.parent.utils.SettingsUtil;
...
public class CallActivity extends BaseLogginedUserActivity
        implements QBRTCClientSessionCallbacks, QBRTCSessionConnectionCallbacks, QBRTCSignalingCallback,
    ...
    QBMessageListener<QBPrivateChat> privateChatMessageListener = new QBMessageListener<QBPrivateChat>() {
        ...
        public void processMessage(QBPrivateChat privateChat, final QBChatMessage chatMessage) {
            Log.d(TAG, "messageReceived " + chatMessage.getBody());
            // TODO connect to robot APIs
        }
        ...
        showIncomingCallWindowTask = new Runnable() {
            ...
            public void run() {
                IncomeCallFragment incomeCallFragment =
                        (IncomeCallFragment) getFragmentManager().findFragmentByTag(INCOME_CALL_FRAGMENT);
    ...
    public void addOpponentsFragment() {
        FragmentExecuotr.addFragment(getFragmentManager(), R.id.fragment_container, new OpponentsFragment(),
    ...
    public void addConversationFragmentStartCall(List<QBUser> opponents, QBRTCTypes.QBConferenceType qbConferenceType,
        ...
        ConversationFragment fragment =
                ConversationFragment.newInstance(opponents, opponents.get(0).getFullName(), qbConferenceType, userInfo,
        ...
        AuthUI.getInstance()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Intent signInIntent = new Intent(CallActivity.this, FirebaseLoginActivity.class);
    ...
    public void addConversationFragmentReceiveCall() {
        ...
        if (getCurrentSession() != null) {
            ...
            ArrayList<QBUser> opponents =
                    DataHolder.getUsersByIDs(opponentsWithoutMe.toArray(new Integer[opponentsWithoutMe.size()]));
            SettingsUtil.setSettingsStrategy(opponents, getDefaultSharedPrefs(), this);
            ConversationFragment fragment =
                    ConversationFragment.newInstance(opponents, DataHolder.getUserNameByID(session.getCallerID()),
    ...
    public void sendMessage(String message, int id) {
        ...
        try {
            ...
            chat = new PrivateChatImpl(chatMessageListener, id);
