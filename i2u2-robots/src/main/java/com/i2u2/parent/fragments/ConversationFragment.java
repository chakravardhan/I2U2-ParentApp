...
import com.i2u2.parent.adapters.OpponentsFromCallAdapter;
import com.i2u2.parent.holder.DataHolder;
import com.i2u2.parent.utils.CameraUtils;
import com.i2u2.parent.utils.Consts;
import com.i2u2.parent.view.RTCGLVideoView;
...
public class ConversationFragment extends Fragment
        implements Serializable, QBRTCClientVideoTracksCallbacks, QBRTCSessionConnectionCallbacks,
        CallActivity.QBRTCSessionUserCallback, OpponentsFromCallAdapter.OnAdapterEventListener {
    ...
    public static ConversationFragment newInstance(List<QBUser> opponents, String callerName,
            ...
            CallActivity.StartConversetionReason reason, String sesionnId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            isVideoEnabled = (qbConferenceType == QBRTCTypes.QBConferenceType.QB_CONFERENCE_TYPE_VIDEO.getValue());
    ...
    private void initViews(View view) {
        ...
        incUserName.setBackgroundResource(
                ListUsersActivity.selectBackgrounForOpponent((DataHolder.getUserIndexByFullName(callerName)) + 1));
    ...
    private void setGrid(int columnsCount, int rowsCount) {
        ...
        int cellSize = defineMinSize(gridWidth, recyclerView.getMeasuredHeight(), columnsCount, rowsCount, itemMargin);
        ...
        OpponentsFromCallAdapter opponentsAdapter = new OpponentsFromCallAdapter(getActivity(), opponents, cellSize,
                cellSize, gridWidth, columnsCount, (int) itemMargin, isVideoEnabled);
    ...
    private void initButtonsListener() {
        ...
        btnDown.setOnTouchListener(new ButtonOnLongClickListener(Consts.MOVE_DOWN));
        btnUp.setOnTouchListener(new ButtonOnLongClickListener(Consts.MOVE_UP));
        btnRight.setOnTouchListener(new ButtonOnLongClickListener(Consts.MOVE_RIGHT));
        btnLeft.setOnTouchListener(new ButtonOnLongClickListener(Consts.MOVE_LEFT));

        btnLeft.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                ((CallActivity) getActivity()).sendMessage(Consts.MOVE_LEFT, opponents.get(0).getId());
            }
        });
        ...
        btnRight.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                ((CallActivity) getActivity()).sendMessage(Consts.MOVE_RIGHT, opponents.get(0).getId());
            }
        });
        ...
        btnUp.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                ((CallActivity) getActivity()).sendMessage(Consts.MOVE_UP, opponents.get(0).getId());
            }
        });
        ...
        btnDown.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                ((CallActivity) getActivity()).sendMessage(Consts.MOVE_DOWN, opponents.get(0).getId());
            }
        });
    }

    private class ButtonOnLongClickListener implements View.OnTouchListener {

        public String message;

        public ButtonOnLongClickListener(String message) {
        ...
        Runnable mAction = new Runnable() {
            ...
            public void run() {
                ...
                ((CallActivity) getActivity()).sendMessage(message, opponents.get(0).getId());
    ...
    private void toggleCamerainternal(QBMediaStreamManager mediaStreamManager) {
        ...
        localVideoView.updateRenderer(
                isPeerToPeerCall ? RTCGLVideoView.RendererSurface.SECOND : RTCGLVideoView.RendererSurface.MAIN, config);
    ...
    private void fillVideoView(RTCGLVideoView videoView, QBRTCVideoTrack videoTrack, boolean remoteRenderer) {
        videoTrack.addRenderer(
                new VideoRenderer(remoteRenderer ? videoView.obtainVideoRenderer(RTCGLVideoView.RendererSurface.MAIN)
